...
#for testing
counts.file <- "/mnt/data/DeSeq_H4/counts_middlepeak.RData"
libsizes.file <- "/mnt/data/DeSeq_H4/libsizes_middlepeak.RData"
outdir <- "/mnt/data/DeSeq_H4"
...
write.csv(res, file=paste(outdir, 'peak_compare_middlepeak.csv', sep='/'), row.names=F)
