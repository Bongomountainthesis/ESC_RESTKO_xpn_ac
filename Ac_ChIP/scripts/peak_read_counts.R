...
ctrl[,"Peak_start"] <- ctrl[,"Peak_start"] - 1
rest[,"Peak_start"] <- rest[,"Peak_start"] - 1

write.table(ctrl, file = "/mnt/data/DeSeq_K9/ctrl_peaks_for_deseq.bed",row.names = F, col.names = F, quote = F)
write.table(rest, file = "/mnt/data/DeSeq_K9/rest_peaks_for_deseq.bed",row.names = F, col.names = F, quote = F)
...
args<-c("/mnt/data/DeSeq_K9",4, "/mnt/data/CME141_GA3R71_export_sorted_nodups.bam" ,"/mnt/data/DeSeq_K9/ctrl_peaks_for_deseq.bed", "/mnt/data/CME143_GA3R71_export_sorted_nodups.bam","/mnt/data/DeSeq_K9/rest_peaks_for_deseq.bed")
